import { config } from "/package_d1fd37fdbb164095b2a0abc9f996207e9bdc5628/uno-config.js";
...
if (config.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('package_d1fd37fdbb164095b2a0abc9f996207e9bdc5628').then(async function (cache) {
